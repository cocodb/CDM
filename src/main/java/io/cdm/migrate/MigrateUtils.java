...
import static io.cdm.route.function.PartitionByCRC32PreSlot.Range;
...
public class MigrateUtils {
    ...
    public static String getDatabaseFromDataNode(String dn) {
        return CDMServer.getInstance().getConfig().getDataNodes().get(dn).getDatabase();
    }

    public static String getDataHostFromDataNode(String dn) {
        return CDMServer.getInstance().getConfig().getDataNodes().get(dn).getDbPool().getHostName();
    }
