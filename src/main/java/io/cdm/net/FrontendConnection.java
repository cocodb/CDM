...
import io.cdm.config.Versions;
import io.cdm.net.handler.FrontendAuthenticator;
import io.cdm.net.handler.FrontendPrepareHandler;
import io.cdm.net.handler.FrontendPrivileges;
import io.cdm.net.handler.FrontendQueryHandler;
import io.cdm.net.handler.LoadDataInfileHandler;
import io.cdm.net.mysql.ErrorPacket;
import io.cdm.net.mysql.HandshakePacket;
import io.cdm.net.mysql.HandshakeV10Packet;
import io.cdm.net.mysql.MySQLPacket;
import io.cdm.net.mysql.OkPacket;
import io.cdm.util.CompressUtil;
import io.cdm.util.RandomUtil;
...
//			return true;
	...
	public void register() throws IOException {
		if (!isClosed.get()) {
			...
			// 发送握手数据包
			boolean useHandshakeV10 = CDMServer.getInstance().getConfig().getSystem().getUseHandshakeV10() == 1;
			if(useHandshakeV10) {
