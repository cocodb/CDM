...
import io.cdm.route.Procedure;
import io.cdm.route.ProcedureParameter;
import io.cdm.util.*;
...
public class JDBCConnection implements BackendConnection {
	...
	public void execute(final RouteResultsetNode node,
		...
		CDMServer.getInstance().getBusinessExecutor().execute(runnable);
	}
