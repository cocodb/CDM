...
public class JDBCDatasource extends PhysicalDatasource {
	...
	static {		
		...
		List<String> drivers = Lists.newArrayList(
				...
				"io.cdm.backend.jdbc.mongodb.MongoDriver",
				"io.cdm.backend.jdbc.sequoiadb.SequoiaDriver",
	...
	public void createNewConnection(ResponseHandler handler,String schema) throws IOException {
		...
		NIOProcessor processor = (NIOProcessor) CDMServer.getInstance().nextProcessor();
