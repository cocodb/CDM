...
import io.cdm.config.loader.zkprocess.comm.NotiflyService;
import io.cdm.config.loader.zkprocess.comm.ZookeeperProcessListen;
...
import io.cdm.config.loader.zkprocess.parse.ParseJsonServiceInf;
import io.cdm.config.loader.zkprocess.parse.ParseXmlServiceInf;
...
import io.cdm.config.loader.zkprocess.zookeeper.DiretoryInf;
import io.cdm.config.loader.zkprocess.zookeeper.process.ZkDirectoryImpl;
import io.cdm.config.loader.zkprocess.zookeeper.process.ZkMultLoader;
...
public class SchemaszkToxmlLoader extends ZkMultLoader implements NotiflyService {
    ...
    */
    ...
    public boolean notiflyProcess() throws Exception {
        ...
        if(CDMServer.getInstance().getStartup().get()) {
