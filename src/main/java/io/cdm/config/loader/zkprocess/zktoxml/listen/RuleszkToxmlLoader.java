...
import io.cdm.config.loader.zkprocess.console.ParseParamEnum;
import io.cdm.config.loader.zkprocess.entity.Property;
...
public class RuleszkToxmlLoader extends ZkMultLoader implements NotiflyService {
    ...
    */
    ...
    public boolean notiflyProcess() throws Exception {
        ...
        if (CDMServer.getInstance().getProcessors() != null)
            ReloadConfig.reload();
