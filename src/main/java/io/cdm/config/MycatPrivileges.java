...
import io.cdm.config.loader.xml.XMLServerLoader;
...
import io.cdm.config.model.UserPrivilegesConfig;
...
public class MycatPrivileges implements FrontendPrivileges {
	...
	public boolean checkFirewallSQLPolicy(String user, String sql) {
		...
		if( contextLocal.get() == null ){
			FirewallConfig firewallConfig = CDMServer.getInstance().getConfig().getFirewall();
