...
import io.cdm.net.mysql.RequestFilePacket;
...
public final class ServerLoadDataInfileHandler implements LoadDataInfileHandler
{
    ...
    public void start(String sql)
    {
        ...
        schema = CDMServer.getInstance().getConfig()
                .getSchemas().get(serverConnection.getSchema());
        tableId2DataNodeCache = (LayerCachePool) CDMServer.getInstance().getCacheService().getCachePool("TableID2DataNodeCache");
