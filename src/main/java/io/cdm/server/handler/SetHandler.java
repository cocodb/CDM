...
import static io.cdm.server.parser.ServerParseSet.AUTOCOMMIT_OFF;
import static io.cdm.server.parser.ServerParseSet.AUTOCOMMIT_ON;
import static io.cdm.server.parser.ServerParseSet.CHARACTER_SET_CLIENT;
import static io.cdm.server.parser.ServerParseSet.CHARACTER_SET_CONNECTION;
import static io.cdm.server.parser.ServerParseSet.CHARACTER_SET_RESULTS;
import static io.cdm.server.parser.ServerParseSet.NAMES;
import static io.cdm.server.parser.ServerParseSet.TX_READ_COMMITTED;
import static io.cdm.server.parser.ServerParseSet.TX_READ_UNCOMMITTED;
import static io.cdm.server.parser.ServerParseSet.TX_REPEATED_READ;
import static io.cdm.server.parser.ServerParseSet.TX_SERIALIZABLE;
import static io.cdm.server.parser.ServerParseSet.XA_FLAG_OFF;
import static io.cdm.server.parser.ServerParseSet.XA_FLAG_ON;
...
import io.cdm.server.parser.ServerParseSet;
import io.cdm.server.response.CharacterSet;
import io.cdm.util.SetIgnoreUtil;
