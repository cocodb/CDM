...
import io.cdm.memory.unsafe.utils.sort.UnsafeKVExternalSorter;
...
public final class UnsafeFixedWidthAggregationMap {
  ...
  public UnsafeKVExternalSorter destructAndCreateExternalSorter() throws IOException {
    return new UnsafeKVExternalSorter(
      ...
      CDMServer.getInstance().getMyCatMemory().getBlockManager(),
      CDMServer.getInstance().getMyCatMemory().getSerializerManager(),
