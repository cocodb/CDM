package io.cdm.memory.unsafe.ringbuffer;


import io.cdm.memory.unsafe.Platform;
import io.cdm.memory.unsafe.memory.mm.MemoryConsumer;
import io.cdm.memory.unsafe.ringbuffer.common.Cursored;
import io.cdm.memory.unsafe.ringbuffer.common.event.*;
import io.cdm.memory.unsafe.ringbuffer.exception.InsufficientCapacityException;
import io.cdm.memory.unsafe.ringbuffer.producer.Sequencer;
...
public class RingBuffer<E extends MemoryConsumer> implements Cursored, EventSequencer<E>, EventSink<E> {
    ...
    /**
     * @see io.cdm.memory.unsafe.ringbuffer.common.DataProvider#get(long)
     */
    @Override
    ...
    /**
     * @see io.cdm.memory.unsafe.ringbuffer.common.event.EventSink#publishEvent(EventTranslator)
     */
    @Override
    ...
    /**
     * @see io.cdm.memory.unsafe.ringbuffer.common.event.EventSink#tryPublishEvent(EventTranslator)
     */
    @Override
