package io.cdm.route.parser.druid;
...
import io.cdm.route.sequence.handler.IncrSequencePropHandler;
    ...
    public DruidSequenceHandler(int seqHandlerType) {
        switch (seqHandlerType) {
            ...
            case SystemConfig.SEQUENCEHANDLER_ZK_DISTRIBUTED:
                sequenceHandler = DistributedSequenceHandler.getInstance(CDMServer.getInstance().getConfig().getSystem());
                break;
