package io.cdm.route.sequence;

import io.cdm.CDMServer;
import io.cdm.route.sequence.handler.*;
		...
		try {
			...
			if(insert.getValuesList()!=null){
				...
				if(sequenceHandler == null){
					int seqHandlerType = CDMServer.getInstance().getConfig().getSystem().getSequnceHandlerType();
