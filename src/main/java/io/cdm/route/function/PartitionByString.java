 ...
 *
 */
package io.cdm.route.function;

import io.cdm.config.model.rule.RuleAlgorithm;
import io.cdm.route.parser.util.Pair;
import io.cdm.route.util.PartitionUtil;
...
public final class PartitionByString extends AbstractPartitionAlgorithm implements RuleAlgorithm  {
	...
	private static int[] toIntArray(String string) {
		String[] strs = io.cdm.util.SplitUtil.split(string, ',', true);
