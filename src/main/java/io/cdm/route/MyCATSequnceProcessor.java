...
import io.cdm.route.parser.druid.DruidSequenceHandler;
...
public class MyCATSequnceProcessor {
	...
	private static final DruidSequenceHandler sequenceHandler = new DruidSequenceHandler(CDMServer
	...
	public void executeSeq(SessionSQLPair pair) {
		try {
			...
			NodeToString strHandler = new ExtNodeToString4SEQ(CDMServer
